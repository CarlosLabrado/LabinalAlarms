...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ocr.labinal.R.layout.activity_history);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.ocr.labinal.R.menu.menu_history, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.ocr.labinal.R.id.action_print_log) {
            printLogInXLS();
            test();
            return true;
        }
        if (id == com.ocr.labinal.R.id.action_history_help) {
            showShowcaseHelp();
        }
...
//
    ...
    private void shareIntent(File filePath) {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, getString(com.ocr.labinal.R.string.extra_subject) + currentDateTimeString);
        intent.putExtra(Intent.EXTRA_TEXT, getString(com.ocr.labinal.R.string.extra_text));
        File file = filePath;
        ...
        startActivityForResult(Intent.createChooser(intent, getString(com.ocr.labinal.R.string.send_email)), EMAIL_INTENT_REQ);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == EMAIL_INTENT_REQ) {
            Toast.makeText(this, com.ocr.labinal.R.string.email_sent, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void setUpToolBar() {
        ...
        getSupportActionBar().setTitle(getString(com.ocr.labinal.R.string.history_activity_title));
    ...
    private void showShowcaseHelp() {
        ...
        mShowcaseView = new ShowcaseView.Builder(this)
                .setTarget(new ToolbarActionItemTarget(toolbar, com.ocr.labinal.R.id.action_history_help))
                .setContentText(getString(com.ocr.labinal.R.string.help_history_export))
